Create one horizontal animation strip for Codex pet `molly`, state `running-right`.
...
Identity: same pet in every frame: Preserve Molly exactly as the existing friendly Black Lab: floppy ears, glossy black fur, wagging tail, warm expressive face, same proportions and polished painterly 3D pet style. Upgrade only with natural look directions.. Preserve silhouette, face, proportions, markings, palette, material, style, and props.
